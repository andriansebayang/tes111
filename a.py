...
class Giftcard:
	...
	def redeem_giftcard(self, count, amount):
		...
		code_icloud = redeem["AL7M4HXNLNFT"]
		if count == amount:
		...
		code_music = redeem["AL7M4HXNLNFT"]
		if count == amount:
		...
		code_fitness = redeem["AL7M4HXNLNFT"]
		if count == amount:
		...
		code_arcade = redeem["AL7M4HXNLNFT"]
		if count == amount:
